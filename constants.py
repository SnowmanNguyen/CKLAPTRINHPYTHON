...
class Image:
    ...
    # Load Player
    PLAYER_SPACE_SHIP = Assets.image.load(Path.GRAPHICS_PATH, 'retro-spaceship.png')
    PLAYER_LASER = Assets.image.load(Path.GRAPHICS_PATH, 'pixel_laser_cosmic.png')
    ...
    BACKSPACE_KEY = Assets.image.scale(Path.GRAPHICS_PATH, 'backspace_key.png', 1/2)
