...
def main():
    ...
    while run:
        ...
        Assets.text.draw('Start Game', title_font, Colors.WHITE, (config.center_x, config.center_y-10), True, True)
        ...
        for event in pygame.event.get():
            ...
            if event.type == pygame.KEYDOWN:
                ...
                if event.key == pygame.K_f:
                    config.update(config.monitor_size[0], config.monitor_size[1])
