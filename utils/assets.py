...
class Assets:
    class text:
        ...
        def draw(text, font, color, pos, isCenterX=False, isCenterY=False, underline=False):
            ...
            if underline:
                pygame.draw.line(config.CANVAS, color,(pos[0], pos[1]+45), (pos[0]+text_label.get_width()-4, pos[1]+45), 7)
    ...
    class image:
        ...
        def scale(root_path, image_path, factor):
            image = pygame.image.load(resource_path(os.path.join(root_path, image_path)))
